...
CREATE TABLE movies(id int, Film_name varchar(40), Price int, Hero varchar(30), Actress varchar(30),Director varchar(30),
 Producer varchar(30),Budget bigint,Language varchar(30));
 
 SELECT * FROM movies;

 INSERT INTO movies VALUES(1, 'Kantara', 100, 'Rishab', 'Sapthami','Yogaraj' , 'Vijay', 1000000, 'Kannada', 2022,7.1 );
 INSERT INTO movies VALUES(2, 'RRR', 110, 'NTR', 'Shradda','Prashanth' , 'Abhijith', 1200000, 'Telugu', 2021,7.2 );
...
ALTER TABLE movies ADD COLUMN Release_year int default 2021;
ALTER TABLE movies ADD COLUMN Vote_average int default 7.2;
...
ALTER TABLE movies MODIFY COLUMN Vote_average bigint;
ALTER TABLE movies MODIFY COLUMN Budget int;
/*change the datatype after inserting*/
ALTER TABLE movies MODIFY COLUMN id int;
ALTER TABLE movies MODIFY COLUMN price int;
ALTER TABLE movies MODIFY COLUMN Release_year int;
ALTER TABLE movies MODIFY COLUMN Vote_average int;
ALTER TABLE movies MODIFY COLUMN Budget bigint;

/*rename the column before inserting*/
ALTER TABLE movies RENAME COLUMN id to Film_id; 
ALTER TABLE movies RENAME COLUMN Film_name to names; 
ALTER TABLE movies RENAME COLUMN Price to ticket_Price; 
ALTER TABLE movies RENAME COLUMN Hero to film_hero ; 
ALTER TABLE movies RENAME COLUMN Actress to film_actress ; 
/*rename the column after inserting*/
ALTER TABLE movies RENAME COLUMN Film_id to id; 
ALTER TABLE movies RENAME COLUMN names to Film_name; 
ALTER TABLE movies RENAME COLUMN ticket_Price to Price ; 
ALTER TABLE movies RENAME COLUMN film_hero to Hero ; 
ALTER TABLE movies RENAME COLUMN film_actress to Actress; 
